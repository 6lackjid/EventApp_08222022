...
class Events(models.Model):
    ...
    EventImage1= models.ImageField(verbose_name="イベントのイメージ1",upload_to=event_images)
    EventImage2= models.ImageField(verbose_name="イベントのイメージ2",upload_to=event_images)
